...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'articles'];
        }
