...
use AppBundle\Entity\UserSubcription as UserSubcription;
...
class User extends BaseUser
{
    ...
    */
    ...
    /**
    * @ORM\OneToMany(targetEntity="AppBundle\Entity\UserSubcription", mappedBy="user",cascade={"persist", "remove"})
    */
